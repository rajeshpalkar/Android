...
public class FragmentRecyclerView1 extends Fragment {
   ...
   // CheckBox mCheckBox = (CheckBox) getView().findViewById(R.id.selection);
    ...
    public static FragmentRecyclerView1 newInstance(int sectionNumber) {
 ...
 //       savedInstanceState.putBoolean("CHECKBOX_STATE", mCheckBox.isChecked());
    ...
    //    mLayoutManager = new GridLayoutManager(getActivity(),2);
        ...
        downloadJsonAsyncTask.execute(" http://api.themoviedb.org/3/movie/popular?api_key=bc9bd96f5f55e22b06f52654aaf41712");
