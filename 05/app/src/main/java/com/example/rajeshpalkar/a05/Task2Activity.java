...
public class Task2Activity extends AppCompatActivity implements FragmentRecyclerView.OnListItemSelectedListener,
FragmentDetails.ChangeTitleToMovie{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView img = (ImageView) findViewById(R.id.ab);
